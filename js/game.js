class Game{
    ...
    play(){
                ...
                Player.getPlayerInfo();
                 image(background_i, 0, 0, 1000, 800);
                 var x =100;
                 var y=200;
                 var index =0;
                 drawSprites();
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 20 === 0) {
                     ...
                     switch(rand){
                         case 1: fruits.addImage("fruit1",apple);
                         break;
                         case 2: fruits.addImage("fruit1", banana);
                         break;
                         case 3: fruits.addImage("fruit1", watermelon);
                         break;
                         case 4: fruits.addImage("fruit1", pinapple);
                         break;
                         case 5: fruits.addImage("fruit1", orange);
                         break;
                     }
